  ...
  return (
    <ScrollView contentContainerStyle={theme.styles.globalPaddingVertical30}>
      ...
      <CollectionCard
        ...
        onPress={() =>
          navigation.navigate('CollectionDetail', {collection_id: 'CT001'})
        }
      />
      <CollectionCard
        ...
        onPress={() =>
          navigation.navigate('CollectionDetail', {collection_id: 'CT002'})
        }
      />
      <CollectionCard
        title="LOVE"
        ...
        onPress={() =>
          navigation.navigate('CollectionDetail', {collection_id: 'CT003'})
        }
      />
      <CollectionCard
        title="TRINITY"
        ...
        onPress={() =>
          navigation.navigate('CollectionDetail', {collection_id: 'CT004'})
        }
      />
      <CollectionCard
        ...
        onPress={() =>
          navigation.navigate('CollectionDetail', {collection_id: 'CT005'})
        }
      />
    </ScrollView>
  );
